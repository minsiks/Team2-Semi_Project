...
public class BuyVO {
	...
	public BuyVO(int id, String uid, String recipient, String recipient_addr, String recipient_phonenumber,
	...
	// 만약 팀원중 필드 추가한게 있다면 다음 생성자 넣어줘야 함 
	public BuyVO(int id, String uid, String recipient, String recipient_addr, String recipient_phonenumber,
			String request, int price, Date regdate, int pid, int size, int cnt, int price_one, String name,
			String imgname1) {
		super();
		this.id = id;
		this.uid = uid;
